...
from shipaw.parcelforce.address import AddressRecipient, Contact as ContactPF
...
class ParcelforceProvider(ShippingProvider):
    ...
    address_type: ClassVar[type[AddressRecipient]] = AddressRecipient
    contact_type: ClassVar[type[ContactPF]] = ContactPF
