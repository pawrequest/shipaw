...
from royal_mail_click_and_drop.models.get_order_info_resource import (
...
class GetOrdersResponse(BaseModel):
    ...
    continuation_token: Optional[StrictStr] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "orders": [
                    GetOrderInfoResource.from_dict(_item) for _item in obj["orders"]
                ]
