...
def returns_address_from_agnostic_fc(full_contact: FullContact):
    ...
    return AddressReturns(
        ...
        address_line2=full_contact.address.address_lines[1] if len(full_contact.address.address_lines) > 1 else '',
        address_line3=full_contact.address.address_lines[2] if len(full_contact.address.address_lines) > 2 else '',
        city=full_contact.address.town,
        county=full_contact.address.county or '',
