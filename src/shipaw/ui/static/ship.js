...
function populateShipment(shipment) {
    ...
    document.getElementById('address_line1').value = shipment.Recipient.Address.AddressLine1 || "";
    document.getElementById('address_line2').value = shipment.Recipient.Address.AddressLine2 || "";
    document.getElementById('address_line3').value = shipment.Recipient.Address.AddressLine3 || "";
